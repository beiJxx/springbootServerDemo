...
@Api(tags = {"${baseRequestMapping} interface"}, description = "${modelNameUpperCamel}Controller")
public class ${modelNameUpperCamel}Controller {
    ...
    @ApiOperation(value = "selectById",notes = "select${modelNameUpperCamel}ById")
    @ApiImplicitParams({
    ...
    */
    ...
    public RetResult<PageInfo<${modelNameUpperCamel}>> list(@RequestParam(defaultValue = "0") Integer page,
        @RequestParam(defaultValue = "0") Integer size, ${modelNameUpperCamel} ${modelNameLowerCamel}) throws Exception {
        PageInfo<${modelNameUpperCamel}> pageInfo = ${modelNameLowerCamel}Service.selectPage(page, size, ${modelNameLowerCamel});
